import { API_BASE_URL, STORAGE } from './constants'
import { getAlert } from '../hooks/useAlert.hooks'
import { ROUTES_CONST } from '@wizard/routes/routes'
import { updateTokenIfMinValidityReached } from './keycloak'
import axios, {
  AxiosProgressEvent,
